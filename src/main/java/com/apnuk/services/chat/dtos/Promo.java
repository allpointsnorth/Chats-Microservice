...
public class Promo implements Serializable {
    ...
    public Promo(int id, String name, String description, Date startTime, Date endTime, BigDecimal amount, String successText, String alreadyClaimedText, String promoNotStartedText, String promoEndedText, boolean joinChat, boolean joinDating, boolean deleted) {
        this.id = id;
        this.name = name;
    ...
    public PromoEntity toEntity(){
        
        return new PromoEntity(this.getId(),
                               this.getName(),
                               this.getDescription(),
                               this.getStartTime(),
                               this.getEndTime(),
