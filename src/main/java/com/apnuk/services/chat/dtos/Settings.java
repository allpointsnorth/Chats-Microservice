 ...
 * define a set of General Settings. ALl time variables are expected to be
...
public class Settings implements Serializable {
  ...
  return new SettingsEntity(this.getId(),
                            this.getCode(),
                            this.getName(),
